    ...
    <div class="modal-content" style="max-width: 400px; padding: 40px;">
      <div style="text-align: center; margin-bottom: 40px;">
        ...
        <p style="color: var(--efinity-text-muted); font-weight: 700; text-transform: uppercase; font-size: 0.7rem; letter-spacing: 0.1em;">
          {needsBootstrap ? 'System Initialization Required' : 'Authentication Required'}
        </p>
      </div>
      
      <label>USERNAME</label>
      <input type="text" bind:value={authUsername} placeholder="e.g. emiel" />
  ...
  <div class="container" transition:fade>
    <header>
      ...
      <div style="display: flex; gap: 20px; align-items: center;">
        ...
        <div class="notification-bell logout-btn" onclick={handleLogout} data-tooltip="Logout">
  ...
  <div class="modal-overlay" onclick={() => showUserModal = false}>
    <div class="modal-content" onclick={(e) => e.stopPropagation()} style="max-width: 450px;">
      <div class="modal-header">
        <h2 style="margin: 0; font-size: 1.8rem; font-weight: 800;">User Settings</h2>
        <p style="color: var(--efinity-text-muted); margin: 4px 0 0 0; font-size: 0.8rem;">Update your tactical profile.</p>
      </div>
      <div class="modal-body">
        ...
        <h4 style="margin-top: 0; font-size: 0.75rem; color: var(--efinity-blue); text-transform: uppercase; letter-spacing: 0.1em; font-weight: 800;">Change Password</h4>
        ...
        <div style="display: flex; gap: 16px; margin-top: 32px;">
          <button style="width: 100%;" onclick={updateProfile}>UPDATE PROFILE</button>
        </div>
      </div>
    </div>
  </div>
